...
You have a microcontroller with a 64×32 grid of colored LEDs on the front and an accellerometer. Over
the next 12 lessons, you'll learn how to use both together to build a simple game while learning the
...
**You cannot break the board by writing bad code** but you can by shaking it _too_ much. These are meant to 
be tilted, not hit or dropoped.
